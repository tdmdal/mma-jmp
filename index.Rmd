...
1. Download and install JMP. Note that the Rotman licensed JMP is Windows only.
    ...
    * (Optional) After installation, launch JMP Pro 15. Under the menu "File > Preferences > JMP Updates", click "Check Now" and follow the instruction to update JMP from version 15.1 to 15.2. (You would need to creat a SAS profile by signing up SAS support community, download an update pacakge, and install it.)  

2. Get familiar with JMP navigation and basic use.

    * Launch JMP Pro 15. Take a quick 5-minute hands-on tutorial under the menu "Help > Tutorials > Beginners Tutorial".
